...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  p { margin-bottom: 8px; }
  code { font-family: 'JetBrains Mono', monospace; font-size: 12px; background: #1d2024; padding: 2px 5px; border-radius: 3px; color: #cfbcff; }
  ...
  blockquote { border-left: 2px solid #cfbcff; padding-left: 12px; margin: 8px 0; color: #948e9c; }
  a { color: #cfbcff; }
  .accent { color: #cfbcff; }
  .flex-row { display: flex; flex-direction: row; gap: 8px; align-items: center; flex-wrap: wrap; }
  .card { background: #15171a; border: 1px solid #272a2f; border-radius: 10px; padding: 12px; margin-bottom: 8px; }
  .pill { display: inline-block; background: #1d2024; border: 1px solid #272a2f; padding: 4px 12px; border-radius: 16px; color: #e6e0e9; font-size: 13px; }
  .pill-active { background: #cfbcff; border-color: #cfbcff; color: #381e72; }
  .bar-bg { background: #1d2024; border-radius: 4px; height: 12px; margin: 4px 0; }
  .bar-fill { background: #cfbcff; border-radius: 4px; height: 12px; }
